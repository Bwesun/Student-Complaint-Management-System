...
<div class="container">
	...
	<div class="col-md-9">
		...
		<div>
			...
			<a href="make_complain.php" class="btn btn-default btn-bg btn-lg"><i class="fas fa-bullhorn"></i>  Make Complaint(s)</a>
			<a href="view_complain.php" class="btn btn-default btn-bg btn-lg"> <i class="fas fa-list"></i>  View My Complaint(s) </a>
		</div>
	</div>
</div>
